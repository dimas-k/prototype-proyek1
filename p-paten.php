...
<head>
    ...
    <title>SIKI | Pengajuan Paten</title>
</head>
<body>
    ...
    <div class="container">
        ...
        <br><br>
        <p class="fs-4 fw-normal font-family-Kokoro">II. FORMULIR PATEN</p>
        <div class="container">
            <form method="post">
            <div class="mb-3">
            <input type="radio" id="paten" name="paten" value="paten">
                    <label for="male">Paten</label><br>
                    <input type="radio" id="paten sederhana" name="paten sederhana" value="paten sederhana">
                    <label for="female">Paten Sederhana</label><br>
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Judul Paten</label>
                    <input type="text" class="form-control" id="" placeholder="Masukkan Judul Paten">
                </div>
                <div class="mb-3">
