...
<body>
    ...
    <div class="container">
        <p class="fs-3 fw-normal font-family-Kokoro text-center">Formulir Pengajuan HKI</p>
        <br>
        <span class="d-flex justify-content-end">
            <a href="https://drive.google.com/drive/folders/1f5IE41Or1oGMMgnziFTYaaI6Vr-9ZrC2" target="_blank" class="link-dark link-underline link-underline-opacity-0" >
